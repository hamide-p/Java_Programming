...
public class Tesla extends Car {
 ...
 /*
        ...
        String[] models = {"Model S", "Model Y", "Model x", "Model 3"}; // convert the Array[] to the collection type
        if (!Arrays.asList(models).contains(models)) { // if specified model is not valid model
    ...
    public void setColor(String color) {
        ...
        if (!colors.contains(color)) { // if specified model is not valid model
