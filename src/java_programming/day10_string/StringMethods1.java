package java_programming.day10_string;
...
public class StringMethods1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(r1 == r3); // false if u compare the value they are not in the same memory (r1 is in the string poll and r3 is out of the string pool
        System.out.println(r2 == r3);  // false

        System.out.println( r1.equals(r3) ); //true to compare the text exactly
