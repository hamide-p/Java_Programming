...
public class ArrayListPractice {
    ...
    public static void main(String[] args) {
        ...
        // We normally use wrapper class objects (String, Integer, Character etc.) in array list, but we can also give custom class objects which are non-primitive data type to the arraylist.
        ...
        maleEmployees.addAll(employees);

        for (Employee employee : femaleEmployees) {

            if (employee.gender == 'M'){ // we can compare charArray with  == operator
