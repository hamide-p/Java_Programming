...
public class MultiDimensionalArrayPractice {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(groups)); // toString() --> is only for single dimensional arrays ONLY


        System.out.println(Arrays.deepToString(groups)); // deepTotoString() --> is for multi dimensional arrays ONLY
